...
import {
  Box, Button, Typography, Menu, RadioGroup,
...
const FilterDropdown = ({ filter, options, selectedOption, onOptionChange, searchEnabled = true }) => {
        ...
        >
          ...
          {filteredOptions.map((option, idx) => (
            <FormControlLabel
              ...
              label={option}
              sx={{
                '.MuiFormControlLabel-label': { fontSize: '13px', textAlign: "center", marginLeft: "0px", color: "#1c1d2e", },
                '&:hover': { backgroundColor: '#f2f2f2', borderRadius: '8px', cursor: 'pointer' },
              }}
            />
          ))}
