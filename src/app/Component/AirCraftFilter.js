        ...
        <Box sx={{ padding: '15px 12px', width: '280px', }}>
          ...
          <Box>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Typography sx={{ fontSize: '14px', fontWeight: '500', margin: "0px 10px", paddingTop: "9px", paddingBottom: "0px" }}>All AirCraft</Typography>
              {
                selectedOptions.length > 0 && (
                  <Button onClick={onReset} sx={{ fontSize: '.9rem', color: '#FFBF00', textTransform: 'none', }}>Reset</Button>
                )
              }
